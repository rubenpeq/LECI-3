...
#Exercicio 2.3
@mock.patch('aula1.contar_ocurrencias', side_effect = aula1.contar_ocurrencias)
def test_remove_e_conta(mock_contar_ocurrencias):
    assert mock_contar_ocurrencias([1,6,2,5,5,2,5,2]) == [(1,1), (6,1), (2,3), (5,3)]
    assert mock_contar_ocurrencias.call_count <= 9
